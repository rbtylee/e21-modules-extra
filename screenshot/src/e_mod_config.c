...
E_Config_Dialog *
e_int_config_screenshot_module(Evas_Object *parent, const char *params)
{
   ...
   cfd = e_config_dialog_new(NULL, D_("Screenshot Settings"), "Screenshot", 
...
_adv_create(E_Config_Dialog *cfd, Evas *evas, E_Config_Dialog_Data *cfdata) 
{
   ...
   e_widget_frametable_object_append(of, ow, 0, 1, 1, 1, 1, 0, 0, 0);
   app_entry = e_widget_entry_add(cfd->dia->win, &(cfdata->app), NULL, NULL, NULL);
